...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-100 to-yellow-50 flex flex-col items-center justify-start px-4 overflow-hidden text-center relative">
      ...
      {/* Main Card */}
      <div className="w-full mt-10 max-w-md bg-white/40 backdrop-blur-md border border-white/30 mb-2 rounded-xl shadow-md p-6 z-10">
        <h1 className="text-3xl font-extrabold text-center text-blue-700 mb-6 drop-shadow-sm tracking-wide">
          URL Shortener
        </h1>
        <UrlForm />
      </div>
